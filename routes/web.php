...
Route::get('admin/users', [Ctrpersonnel::class, 'index'])->name('index_users');
Route::get('admin/get_list_users', [Ctrpersonnel::class, 'get_list_users'])->name('get_list_users');
Route::get('admin/get_agent', [Ctrpersonnel::class, 'get_affectation'])->name('get_agent');
Route::post('admin/save_users', [Ctrpersonnel::class, 'save_users'])->name('save_users');
Route::post('admin/update_users', [Ctrpersonnel::class, 'update_users'])->name('update_users');
...
//________________________________debut transfert___________________________
