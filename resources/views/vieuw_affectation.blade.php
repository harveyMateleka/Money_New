      ...
      <div class="card-body">
         <form action="#" method="POST" id="form_affectation">
           ...
           <div class="form-row">
             ...
             <div class="row">
               <div class="form-row">
             <button type="button" class="btn btn-success" name="btnsave_users" id="btnsave_affectation">Enregistre</button>
            <button type="button" class="btn btn-danger" id="btnreset_affectation">annule</button>
