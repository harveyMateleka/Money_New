...
<html lang="en">
   ...
   @yield('content')
   <script src="{{ asset('accueil/accueil/js/jquery-3.3.1.min.js')}}"></script>
   <script src="{{ asset('accueil/js/jquery-migrate-3.0.1.min.js')}}"></script>
   ...
   <script src="{{ asset('accueil/js/jquery.stellar.min.js')}}"></script>
   <script src="{{ asset('accueil/js/jquery.countdown.min.js')}}"></script>
   <script src="{{ asset('accueil/js/bootstrap-datepicker.min.js')}}"></script>
   ...
   <script src="{{asset('accueil/js/jquery.mb.YTPlayer.min.js')}}"></script>
