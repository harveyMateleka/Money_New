         ...
         <div class="layout-inner">
            ...
            <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-dark">
               ...
               <div class="app-brand demo">
                  ...
                  <a href="index.html" class="app-brand-text demo sidenav-text font-weight-normal ml-2">ABT-TRANSFERTS</a>
               ...
               <ul class="sidenav-inner py-1">
                  ...
                  <li class="sidenav-item">
                     <a href="javascript:" class="sidenav-link sidenav-toggle">
                        ...
                        <div>Gestion du personnel</div>
                     </a>
                     <ul class="sidenav-menu">
                        <li class="sidenav-item">
                           <a href="{{url('/GestionPersonel')}}" class="sidenav-link">
                              <div>Personnel</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/ville')}}" class="sidenav-link">
                              <div>Utilisateurs</div>
                           </a>
                        </li>
                        <li class="sidenav-item ">
                           <a href="{{url('/agence')}}" class="sidenav-link">
                              <div>Affectation</div>
                           </a>
                        </li>
                     </ul>
                  ...
                  <li class="sidenav-item">
                     <a href="javascript:" class="sidenav-link sidenav-toggle">
                        ...
                        <div>Gestion Transaction</div>
                     </a>
                     <ul class="sidenav-menu">
                        <li class="sidenav-item">
                           <a href="{{url('/depot')}}" class="sidenav-link">
                              <div>Envoie D'argent</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/retrait')}}" class="sidenav-link">
                              <div>Retrait D'argent</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                  ...
                  <li class="sidenav-item">
                     ...
                     <ul class="sidenav-menu">
                        <li class="sidenav-item">
                           <a href="{{route('route_index_ville')}}" class="sidenav-link">
                              <div>Ajout Ville</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/mouvbanque')}}" class="sidenav-link">
                              <div>Ajout Fonction</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/mouvbanque')}}" class="sidenav-link">
                              <div>Ajout Type Depense</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/mouvbanque')}}" class="sidenav-link">
                              <div>Ajout Type MVBanque</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/mouvbanque')}}" class="sidenav-link">
                  ...
                  <li class="sidenav-item">
                     <a href="javascript:" class="sidenav-link sidenav-toggle">
                        <i class="sidenav-icon feather icon-grid"></i>
                        <div>Mouvement Banque</div>
                     </a>
                     <ul class="sidenav-menu">
                        <li class="sidenav-item">
                           <a href="{{url('/mouvbanque')}}" class="sidenav-link">
                              <div>Approvisionement</div>
                           </a>
                        </li>
                        <li class="sidenav-item">
                           <a href="{{url('/repartitionbank')}}" class="sidenav-link">
                              <div>bank and bank</div>
                           </a>
                        </li>
                     </ul>
                  </li>
            ...
            <div class="layout-container">
               ...
               <nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-dark container-p-x" id="layout-navbar">
                  ...
                  <span class="app-brand-text demo font-weight-normal ml-2">ABT-TRANSFERTS</span>
                  </a>
               ...
               <nav class="layout-footer footer bg-white">
                  <div class="container-fluid d-flex flex-wrap justify-content-between text-center container-p-x pb-3">
                     <div class="pt-3">
                        <span class="footer-text font-weight-semibold">&copy; <a href="" class="footer-link" target="_blank">ABT-TRANSFERTS</a></span>
                     </div>
                     <div>
